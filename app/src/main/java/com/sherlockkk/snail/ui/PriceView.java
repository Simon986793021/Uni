package com.sherlockkk.snail.ui;
...
public class PriceView extends View{
    ...
    private void getProperties(Context context, AttributeSet attrs){  
        ...
        int textSize = a.getDimensionPixelSize(R.styleable.PriceView_textSize, 14);  
        String value = a.getString(R.styleable.PriceView_value);  
        int textColor = a.getColor(R.styleable.PriceView_textColor, 0xffffff);  
        int moneySize = a.getDimensionPixelSize(R.styleable.PriceView_moneySize, textSize);  
        int intSize = a.getDimensionPixelSize(R.styleable.PriceView_intSize, textSize);
        int decimalSize = a.getDimensionPixelSize(R.styleable.PriceView_decimalSize, textSize);  
        boolean strike = a.getBoolean(R.styleable.PriceView_strike, false);  
        boolean withEndZero = a.getBoolean(R.styleable.PriceView_withEndZero, true);  
        this.value = value;  
