...
public class PartTimeJobListAdapter extends BaseAdapter {
    ...
    public PartTimeJobListAdapter(Context mcontext)
    {
        this.layoutInflater=LayoutInflater.from(mcontext);
    }
    public void addList(List<PartTimeJob> mlist) {
        list = mlist;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.starttimeTextView.setText("兼职时间："+list.get(position).getActivityTime().trim().toString());
        int acount;
