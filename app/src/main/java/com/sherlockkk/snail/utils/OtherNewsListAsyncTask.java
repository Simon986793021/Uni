 ...
 * 另外一个新闻网络请求任务 ，因为头条和其他类型的新闻json字段不一样 ，分别获取。
 */
public class OtherNewsListAsyncTask extends AsyncTask<String,Void,List<NewsList>>{
    private ListView listView;
    private Context context;
    public static List<NewsList> list;
    public OtherNewsListAsyncTask(ListView listView, Context context)
    {
    ...
    private List<NewsList> getJsonData(String param) {
        ...
        try {
            ...
            for (int i = 0; i < jsonarray.length(); i++) {
                ...
                newslist.realtype=jsonobject.getString("author_name");
