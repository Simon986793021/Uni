 ...
 */
public class InternationalNewsActivity extends Activity{
    private TextView backTextView;
    private TextView toolbarTextView;
    private ListView listView;
    private String URL="http://v.juhe.cn/toutiao/index?type=guoji&key=65d4c89f2460e131bd8b288f3f70bff6";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbarTextView.setText("国际新闻");
        new NewsListAsyncTask(listView,InternationalNewsActivity.this).execute(URL);
